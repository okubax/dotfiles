" Name: nord_dark.vim
" Nord Dark: the classic/canonical Nord palette (nordtheme.com). See
" ~/dotfiles/swaywm/nord/README.md and dark/palette.md for the full
...
let g:colors_name='nord_dark'
set t_Co=256

" bg          = "#2E3440"  (Nord nord0, Polar Night)
" bg_alt      = "#3B4252"  (Nord nord1, Polar Night)
" bg_panel    = "#434C5E"  (Nord nord2, Polar Night)
" bg_panel_alt= "#4C566A"  (Nord nord3, Polar Night)
...
hi Normal           guisp=NONE      guifg=#ECEFF4   guibg=#2E3440   ctermfg=255     ctermbg=236  gui=NONE           cterm=NONE
hi Visual           guisp=NONE      guifg=NONE      guibg=#3E5A66   ctermfg=NONE    ctermbg=24   gui=bold           cterm=bold

hi Conceal          guisp=NONE      guifg=#D8DEE9   guibg=NONE      ctermfg=253     ctermbg=NONE gui=NONE           cterm=NONE
hi ColorColumn      guisp=NONE      guifg=NONE      guibg=#4C566A   ctermfg=NONE    ctermbg=239  gui=NONE           cterm=NONE
hi Cursor           guisp=NONE      guifg=#2E3440   guibg=#88C0D0   ctermfg=236     ctermbg=110   gui=NONE           cterm=NONE
hi lCursor          guisp=NONE      guifg=#2E3440   guibg=#88C0D0   ctermfg=236     ctermbg=110   gui=NONE           cterm=NONE
hi CursorIM         guisp=NONE      guifg=#2E3440   guibg=#88C0D0   ctermfg=236     ctermbg=110   gui=NONE           cterm=NONE
hi CursorColumn     guisp=NONE      guifg=NONE      guibg=#3B4252   ctermfg=NONE    ctermbg=237  gui=NONE           cterm=NONE
hi CursorLine       guisp=NONE      guifg=NONE      guibg=#3B4252   ctermfg=NONE    ctermbg=237  gui=NONE           cterm=NONE
hi Directory        guisp=NONE      guifg=#81A1C1   guibg=NONE      ctermfg=109      ctermbg=NONE gui=NONE           cterm=NONE
hi DiffAdd          guisp=NONE      guifg=#2E3440   guibg=#A3BE8C   ctermfg=236     ctermbg=150   gui=NONE           cterm=NONE
...
hi DiffText         guisp=NONE      guifg=#2E3440   guibg=#88C0D0   ctermfg=236     ctermbg=110   gui=NONE           cterm=NONE
...
hi Folded           guisp=NONE      guifg=#81A1C1   guibg=#4C566A   ctermfg=109      ctermbg=239  gui=NONE           cterm=NONE
hi FoldColumn       guisp=NONE      guifg=#D8DEE9   guibg=#2E3440   ctermfg=253     ctermbg=236  gui=NONE           cterm=NONE
hi SignColumn       guisp=NONE      guifg=#4C566A   guibg=#2E3440   ctermfg=239     ctermbg=236  gui=NONE           cterm=NONE
...
hi Pmenu            guisp=NONE      guifg=#ECEFF4   guibg=#4C566A   ctermfg=255     ctermbg=239  gui=NONE           cterm=NONE
hi PmenuSel         guisp=NONE      guifg=#2E3440   guibg=#88C0D0   ctermfg=236     ctermbg=110   gui=bold           cterm=bold
hi PmenuSbar        guisp=NONE      guifg=NONE      guibg=#4C566A   ctermfg=NONE    ctermbg=239  gui=NONE           cterm=NONE
...
hi QuickFixLine     guisp=NONE      guifg=NONE      guibg=#4C566A   ctermfg=NONE    ctermbg=239  gui=bold           cterm=bold
hi Search           guisp=NONE      guifg=#2E3440   guibg=#3E5A66   ctermfg=236     ctermbg=24   gui=bold           cterm=bold
...
hi StatusLine       guisp=NONE      guifg=#ECEFF4   guibg=#4C566A   ctermfg=255     ctermbg=239  gui=NONE           cterm=NONE
hi StatusLineNC     guisp=NONE      guifg=#D8DEE9   guibg=#4C566A   ctermfg=253     ctermbg=239  gui=NONE           cterm=NONE
hi TabLine          guisp=NONE      guifg=#D8DEE9   guibg=#4C566A   ctermfg=253     ctermbg=239  gui=NONE           cterm=NONE
hi TabLineFill      guisp=NONE      guifg=NONE      guibg=#4C566A   ctermfg=NONE    ctermbg=239  gui=NONE           cterm=NONE
hi TabLineSel       guisp=NONE      guifg=#A3BE8C   guibg=#2E3440   ctermfg=150      ctermbg=236  gui=NONE           cterm=NONE
hi Title            guisp=NONE      guifg=#81A1C1   guibg=NONE      ctermfg=109      ctermbg=NONE gui=bold           cterm=bold
hi VisualNOS        guisp=NONE      guifg=NONE      guibg=#3E5A66   ctermfg=NONE    ctermbg=24   gui=bold           cterm=bold
...
hi Underlined       guisp=NONE      guifg=#ECEFF4   guibg=#2E3440   ctermfg=255     ctermbg=236  gui=underline      cterm=underline
...
hi debugPC          guisp=NONE      guifg=NONE      guibg=#4C566A   ctermfg=173     ctermbg=NONE gui=NONE           cterm=NONE
hi debugBreakpoint  guisp=NONE      guifg=#D8DEE9   guibg=#2E3440   ctermfg=173     ctermbg=NONE gui=NONE           cterm=NONE
