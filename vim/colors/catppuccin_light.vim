" Name: catppuccin_light.vim
" Catppuccin Latte, renamed to fit this repo's light/dusk/dark convention.
" See ~/dotfiles/swaywm/catppuccin/README.md and light/palette.md.
...
let g:colors_name='catppuccin_light'
set t_Co=256
...
hi SpecialKey       guisp=NONE      guifg=#6C6F85   guibg=NONE      ctermfg=254     ctermbg=NONE gui=NONE           cterm=NONE
