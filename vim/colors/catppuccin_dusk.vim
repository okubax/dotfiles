" Name: catppuccin_dusk.vim
" Catppuccin Macchiato, renamed to fit this repo's light/dusk/dark
" convention. See ~/dotfiles/swaywm/catppuccin/README.md and
" dusk/palette.md.
...
let g:colors_name='catppuccin_dusk'
set t_Co=256
