" Name: catppuccin_dark.vim
" Catppuccin Mocha, renamed to fit this repo's light/dusk/dark convention.
" See ~/dotfiles/swaywm/catppuccin/README.md and dark/palette.md.
...
let g:colors_name='catppuccin_dark'
set t_Co=256
